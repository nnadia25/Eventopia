...
class EventopiaApp:
    ...
    def create_widgets(self):
        ...
        concert_button = tk.Button(self.root, text="Suara Sejuta Rasa", command=self.show_concert_event)
    ...
    def confirm_purchase(self, event, entries, top):
        ...
        messagebox.showinfo("Pembelian Berhasil", f"Anda telah membeli tiket untuk {event[0]}")
        top.destroy()
